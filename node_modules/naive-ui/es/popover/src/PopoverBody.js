            ...
            if (!renderBody) {
                ...
                const renderContentInnerNode = () => {
                    const content = resolveWrappedSlot(slots.header, (children) => {
                        var _a;
                        const body = children ? (h(Fragment, null,
                            h("div", { class: `${mergedClsPrefix}-popover__header`, style: props.headerStyle }, children),
                            h("div", { class: `${mergedClsPrefix}-popover__content`, style: props.contentStyle }, slots))) : props.scrollable ? ((_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots)) : (h("div", { class: `${mergedClsPrefix}-popover__content`, style: props.contentStyle }, slots));
