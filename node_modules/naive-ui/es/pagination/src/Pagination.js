...
export default defineComponent({
    ...
    render() {
        ...
        return (h("div", { ref: "selfRef", class: [
            ...
            showSizePicker ? (h(NSelect, { internalShowCheckmark: false, size: selectSize, placeholder: "", options: pageSizeOptions, value: mergedPageSize, disabled: disabled, theme: mergedTheme.peers.Select, themeOverrides: mergedTheme.peerOverrides.Select, onUpdateValue: handleSizePickerChange })) : null,
