...
declare const props: {
    ...
    readonly filter: PropType<(pattern: string, node: import("../../tree").TreeOption) => boolean>;
    ...
    readonly 'onUpdate:expandedKeys': PropType<MaybeArray<import("../../tree/src/Tree").OnUpdateKeys>>;
    readonly bordered: {
