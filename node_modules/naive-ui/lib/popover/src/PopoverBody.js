            ...
            if (!renderBody) {
                ...
                const renderContentInnerNode = () => {
                    const content = (0, _utils_1.resolveWrappedSlot)(slots.header, (children) => {
                        var _a;
                        const body = children ? ((0, vue_1.h)(vue_1.Fragment, null,
                            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-popover__header`, style: props.headerStyle }, children),
                            (0, vue_1.h)("div", { class: `${mergedClsPrefix}-popover__content`, style: props.contentStyle }, slots))) : props.scrollable ? ((_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots)) : ((0, vue_1.h)("div", { class: `${mergedClsPrefix}-popover__content`, style: props.contentStyle }, slots));
