...
const TreeNode = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const disabledRef = (0, vue_1.computed)(() => NTree.disabledRef.value || props.tmNode.disabled);
        ...
        const selectableRef = (0, vooks_1.useMemo)(() => !props.tmNode.disabled &&
        ...
        return {
            ...
            checked: (0, vooks_1.useMemo)(() => NTree.displayedCheckedKeysRef.value.includes(props.tmNode.key)),
    ...
    render() {
        ...
        return ((0, vue_1.h)("div", Object.assign({ class: `${clsPrefix}-tree-node-wrapper` }, dragEventHandlers),
            (0, vue_1.h)("div", Object.assign({}, (blockLine ? nodeProps : undefined), { class: [
                    ...
                    : undefined }),
                (0, seemly_1.repeat)(tmNode.level, (0, vue_1.h)("div", { class: `${clsPrefix}-tree-node-indent` },
                    (0, vue_1.h)("div", { style: { width: `${indent}px` } }))),
                (0, vue_1.h)(TreeNodeSwitcher_1.default, { clsPrefix: clsPrefix, expanded: this.expanded, loading: this.loading, hide: tmNode.isLeaf, onClick: this.handleSwitcherClick }),
