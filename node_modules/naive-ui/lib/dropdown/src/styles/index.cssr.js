...
`, [(0, fade_in_scale_up_cssr_1.fadeInScaleUpTransition)(), (0, cssr_1.cB)('dropdown-option', `
 position: relative;
 `, [(0, cssr_1.c)('a', `
 ...
 `), (0, cssr_1.cM)('pending', {
  ...
  color: 'var(--n-option-text-color-active)'
}), (0, cssr_1.c)('&::before', 'background-color: var(--n-option-color-active);')]), (0, cssr_1.cM)('disabled', {
  cursor: 'not-allowed',
